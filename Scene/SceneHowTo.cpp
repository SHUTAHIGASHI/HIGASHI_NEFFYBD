...
namespace
{
	const char* const kTextBack = "ƒlƒtƒB‚³‚ñ‚ª”O‚¶‚½‚ç–ß‚è‚Ü‚·";
}
...
void SceneHowTo::Draw()
{
	...
	{
		DrawFormatStringF(Game::kScreenWidthHalf - (stringLength / 2), Game::kScreenHeight - 70, Game::kColorRed, "%s", kTextBack);
	}
}
